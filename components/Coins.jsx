...
export const Coins = () => {
    return(
        <div className='coins-wrapper'>
            <div className='py-8'>
                <Title title="PLAY TO EARN" desc="Play daily to earn solid weekly rewards. 
                Utilise your heroes well in earning income for yourself, and for others. 
                ...
                <div className='coin-grid mx-auto grid gap-8 play-to-earn p-8  '>
                    <div className='flex flex-col items-center'>
                        <img width="300" src="/assets/images/zenny.png"/>
                    ...
                    <div className='flex flex-col  items-center'>
                        <img width="300" src="/assets/images/evergem.png"/>
                        <div className='color-nine px-4 flex flex-col items-center justify-center  text-center'>
                    ...
                    <div className='flex flex-col  items-center'>
                        <img width="300" src="/assets/images/creo-engine.png"/>
                        <div className='color-nine px-4 flex flex-col items-center justify-center text-center '>
