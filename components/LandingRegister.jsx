...
export const LandingRegister = ()=>{
    return(
        <div className="pre-register-landing-wrapper w-full ">
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"  viewBox="0 0 1920 1205">
                <defs>
                    ...
                    <stop offset="0.656" stopColor="#d9d9d9"/>
                    <stop offset="1" stopColor="#d9d9d9" stopOpacity="0"/>
                    </linearGradient>
                    <clipPath id="clip-path">
                    <rect id="Rectangle_1173" data-name="Rectangle 1173" width="1920" height="1205" fill="#fff" stroke="#707070" strokeWidth="1"/>
                    </clipPath>
                    <pattern id="pattern" width="1" height="1" viewBox="0.181 59.26 650.232 750.691">
                    <image preserveAspectRatio="none" width="650.594" height="1007.003" xlinkHref="/assets/images/character_left_top.png"/>
                    </pattern>
                    <pattern id="pattern-2" preserveAspectRatio="xMidYMid slice" width="100%" height="100%" viewBox="0 0 617 259">
                    <image width="617" height="259" xlinkHref="/assets/images/logo_landing_pre.png"/>
                    </pattern>
                    <pattern id="pattern-3" preserveAspectRatio="xMidYMid slice" width="100%" height="100%" viewBox="0 0 1402 1096">
                    <image width="1402" height="1096" xlinkHref="/assets/images/character_left_bottom.png"/>
                    </pattern>
                    <filter id="JOIN_NOW" x="768.055" y="557.784" width="342" height="129" filterUnits="userSpaceOnUse">
                    ...
                    <linearGradient id="linear-gradient-3" x1="0.495" x2="2.314" y2="1.021" gradientUnits="objectBoundingBox">
                    ...
                    <filter id="Vector-2" x="748.196" y="669.472" width="388.068" height="134.939" filterUnits="userSpaceOnUse">
                    <feOffset dx="-0.321" dy="0.642" input="SourceAlpha"/>
                    <feGaussianBlur stdDeviation="0.642" result="blur-2"/>
                    <feFlood floodOpacity="0.251"/>
                    <feComposite operator="in" in2="blur-2"/>
                    <feComposite in="SourceGraphic"/>
                    </filter>
                    <clipPath id="clip-path-3">
                    <rect id="Rectangle_15" data-name="Rectangle 15" width="738.387" height="707.267" transform="translate(1980.682 764.267) rotate(180)" fill="url(#linear-gradient-2)"/>
                    </clipPath>
                    <pattern id="pattern-4" width="1" height="1" viewBox="3.896 0.33 734.446 892.177">
                    <image preserveAspectRatio="none" width="742.465" height="882.003" xlinkHref="/assets/images/character_right_top.png"/>
                    </pattern>
                    <pattern id="pattern-5" preserveAspectRatio="xMidYMid slice" width="100%" height="100%" viewBox="0 0 1567 1400">
                    <image width="1567" height="1400" xlinkHref="/assets/images/character_right_bottom.png"/>
                    </pattern>
                </defs>
                <g id="Mask_Group_69" data-name="Mask Group 69" clipPath="url(#clip-path)">
                    <rect id="_0000s_0006_curtis_1" data-name="_0000s_0006_curtis 1" width="650.594" height="869.695" transform="translate(79.03 72.293)" fill="url(#pattern)"/>
                    <rect id="Evermore_Knight_Logo_Blue_Glow_2" data-name="Evermore Knight_Logo_Blue Glow 2" width="708" height="298.141" transform="translate(589 266.054)" fill="url(#pattern-2)"/>
                    <rect id="_0000s_0004_teen-female" width="707.737" height="553.066" transform="translate(-86.046 701.23) rotate(-13.709)" fill="url(#pattern-3)"/>
                    <g transform="matrix(1, 0, 0, 1, 0, 0)" filter="url(#JOIN_NOW)">
                        <text id="JOIN_NOW-2" data-name="JOIN NOW" transform="translate(954.05 641.78)" fill="#fff" fontSize="42" letterSpacing="0.085em"><tspan x="-140.544" y="0">JOIN NOW</tspan></text>
                    </g>
                    <a onClick={()=>console.log("btn register clicked")}>
                        <g id="Group_3069" data-name="Group 3069" transform="translate(0 -139.08)">
                            <g id="btn_blue">
                                <g id="Group_3068" data-name="Group 3068">
                                    ...
                                    <path id="Vector-4" data-name="Vector" d="M382.218,63.072l-30.275,65.6L30.275,127.406,0,63.072,28.381,0h321.67Z" transform="translate(751.706 812.359)" fill="url(#linear-gradient-3)"/>
                                    ...
                                    <g id="Mask_group" data-name="Mask group" opacity="0.4">
                                        <g id="Vector-5" data-name="Vector" clipPath="url(#clip-path-2)">
                                    ...
                                    <g transform="matrix(1, 0, 0, 1, 0, 139.08)" filter="url(#Vector-2)">
                                        <path id="Vector-42" data-name="Vector" d="M10.342,72.963,5.373,65.542l4.969-7.407,4.969,7.407ZM372.869,58.136l4.969,7.407-4.969,7.407L367.9,65.542Zm11.344,7.407L352.8,131.084H31.414L0,65.542,31.414,0h321.4ZM373.8,50.714l-9.773,14.828L373.8,80.37l7.109-14.828ZM3.308,65.542,10,79.5l9.2-13.961L10,51.581Zm369.92,16-10.551-16,10.551-16L350.9,2.939H33.3L10.566,50.406l9.968,15.136L10.566,80.679l22.749,47.467h317.6Z" transform="matrix(1, 0, 0, 1, 750.44, 670.76)" fill="#c3a76d"/>
                                    </g>
                                </g>
                            </g>
                            <text id="PRE-REGISTER" transform="translate(734.444 850.432)" fill="#fff" fontSize="40"  fontWeight="700"><tspan x="57.146" y="43" xmlSpace="preserve">PRE-REGISTER         </tspan></text>
                        </g>
                    </a>
                    <g id="Mask_group-2" data-name="Mask group">
                        <g id="Rectangle_15-2" data-name="Rectangle 15" clipPath="url(#clip-path-3)">
                            <rect id="_0000s_0002_Astra_2" data-name="_0000s_0002_Astra 2" width="734.222" height="882.003" transform="translate(1223.095 149.81) rotate(-9.799)" fill="url(#pattern-4)"/>
                        </g>
                    </g>
                    <rect id="_0000s_0003_Adult-male_1" data-name="_0000s_0003_Adult-male 1" width="735" height="654" transform="translate(1238 551)" fill="url(#pattern-5)"/>
                </g>
            </svg>
        </div>
    )
